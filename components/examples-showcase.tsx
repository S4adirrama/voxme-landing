...
// Update the dictionary prop type to reflect the examplesShowcase structure
interface ExamplesShowcaseDictionary {
  musicGallery: string
  allGenres: string
  musicStyles: string[]
}

export default function ExamplesShowcase({ dictionary }: { dictionary: ExamplesShowcaseDictionary }) {
  const [playingTrack, setPlayingTrack] = useState<number | null>(null)
  const audioRefs = useRef<Array<HTMLAudioElement | null>>([])

  const musicStyles = dictionary.musicStyles // Use styles from dictionary

  const featuredExamples = [
    {
      title: "Sunset Exit",
      style: musicStyles[0], // POP
      prompt: "Upbeat pop song about summer vacation",
      image:
        "https://storage.googleapis.com/corpusant-app-public/riffs/328c462e-e215-4ade-8131-3368ad65eac3/image/f7be7ee7-785d-49fb-bc75-75d0134ec189.jpg",
      color: "from-pink-500 to-purple-500",
      audio: "https://res.cloudinary.com/dxf0fmf9a/video/upload/v1751521887/Sunset_Exit_spuha0.mp3",
    },
    {
      title: "Rainy Study",
      style: musicStyles[4], // LO-FI (ELECTRONIC)
      prompt: "Relaxing lo-fi hip hop for studying",
      image:
        "https://storage.googleapis.com/corpusant-app-public/riffs/328c462e-e215-4ade-8131-3368ad65eac3/image/98ef63b3-88f7-4f4f-a3b9-2811ef28a6bb.jpg",
      color: "from-blue-500 to-indigo-500",
      audio: "https://res.cloudinary.com/dxf0fmf9a/video/upload/v1751522687/Rainy_Study_vkvxk2.mp3",
    },
    {
      title: "Breaking",
      style: musicStyles[2], // HIP-HOP
      prompt: "Powerful rock anthem with guitar solos",
      image:
        "https://storage.googleapis.com/corpusant-app-public/riffs/328c462e-e215-4ade-8131-3368ad65eac3/image/7b31ce3e-a1b7-4aed-bdbb-70408244eba2.jpg",
      color: "from-yellow-500 to-orange-500",
      audio: "https://res.cloudinary.com/dxf0fmf9a/video/upload/v1751523849/Breaking_ztvzx9.mp3",
    },
    {
      title: "Silent Echo",
      style: musicStyles[3], // JAZZ
      prompt: "Smooth jazz with saxophone and piano",
      image:
        "https://storage.googleapis.com/corpusant-app-public/riffs/328c462e-e215-4ade-8131-3368ad65eac3/image/5b841dab-0cea-4dd4-8658-06339468f87c.jpg",
    ...
    },
    {
      ...
      image:
        "https://storage.googleapis.com/corpusant-app-public/riffs/328c462e-e215-4ade-8131-3368ad65eac3/image/1f3f9a2c-6ea8-4be1-bb51-a1d4bfcaf424.jpg",
      color: "from-pink-500 to-rose-500",
      audio: "https://res.cloudinary.com/dxf0fmf9a/video/upload/v1751524696/Lost_Youth_j8knfc.mp3",
    },
    {
      title: "Resilience",
      style: musicStyles[5], // CLASSICAL
      prompt: "Cinematic orchestral piece with crescendo",
      image:
        "https://storage.googleapis.com/corpusant-app-public/riffs/328c462e-e215-4ade-8131-3368ad65eac3/image/f32e0bc2-11f4-4fa0-a440-435cccb06bb0.jpg",
              ...
              <div className="bg-white/5 rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div
                      className={`w-14 h-14 bg-gradient-to-r ${example.color} rounded-full flex items-center justify-center`}
                    >
                      {playingTrack === index ? (
                ...
                <audio ref={(el) => (audioRefs.current[index] = el)} src={example.audio} preload="auto" />
              </div>
            </div>
          ))}
        </div>
