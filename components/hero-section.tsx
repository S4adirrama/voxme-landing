  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-black px-6">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        {/* Правая часть: демо-видео */}
        <div className="relative group w-full aspect-video rounded-3xl overflow-hidden border border-white/10 backdrop-blur-xl shadow-2xl">
          <video
            autoPlay
            muted
            loop
          ...
          {/* Тёмный градиент сверху для контраста */}
